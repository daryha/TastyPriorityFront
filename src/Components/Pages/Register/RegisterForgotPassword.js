...
const RegisterForgotPassword = () => {
	...
	const handlePasswordResetRequest = () => {
		...
		axios
			.post('https://tasty-priority-server-1482c4db125b.herokuapp.com/api/accounts/password-reset-request/', {
				email,
			})
			.then(response => {
				setMessage(
	...
	const handlePasswordChangeRequest = () => {
		...
		axios
			.post('https://tasty-priority-server-1482c4db125b.herokuapp.com/api/accounts/reset-password-confirm/', {
				code,
				email,
				newPassword,
			})
