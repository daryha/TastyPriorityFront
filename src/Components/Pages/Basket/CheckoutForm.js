	...
	const fetchCartItems = async () => {
		...
		try {
			const response = await axios.get(
				'https://tasty-priority-server-1482c4db125b.herokuapp.com/api/cart/',
				{
					headers: {
	...
	const handleRemoveProduct = async cartItemId => {
		...
		try {
			const response = await axios.delete(
				`https://tasty-priority-server-1482c4db125b.herokuapp.com/api/cart/remove/${cartItemId}/`,
				{
					headers: {
						Authorization: `Token ${token}`,
					},
	...
	const handleSubmit = async event => {
		...
		try {
			const response = await axios.post(
				'https://tasty-priority-server-1482c4db125b.herokuapp.com/api/create-order/',
